...
namespace MusicSampler.Controllers
{
    public class SamplesController : ApiController
    {
        ...
        public IHttpActionResult GetSample(string id)
        {
            ...
            else
            {
                ...
                Sample s = new Sample()
                {
                    ...
                    SampleBlobURL = sampleEntity.SampleBlobURL
                };
                return Ok(s);
            }
        }
        ...
        public IHttpActionResult PostProduct(Sample sample)
        {
            SampleEntity sampleEntity = new SampleEntity()
            {
                ...
                SampleBlobURL = sample.SampleBlobURL
            };
        ...
        public IHttpActionResult PutProduct(string id, Sample sample)
        {
            ...
            updateEntity.SampleBlobURL= sample.SampleBlobURL;
